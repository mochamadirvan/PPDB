          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- form start -->
                <?php echo form_open_multipart('guru/edit');?>
                  <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="">NIP</label>
                        <input type="text" class="form-control" value="<?php echo $record['nip']?>"  name="nip" pattern="[0-9]+" title="Tuliskan Angka 0-9 placeholder="Isikan kegiatan" required>
                    </div>
                      <div class="form-group">
                      ...
                      <label for="">Email</label>
                        <input type="text" class="form-control" value="<?php echo $record['email']?>"  name="email" placeholder="Isikan kegiatan" required>
                    </div>
