            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php echo form_open_multipart('berita/edit');?>
                  <input type="hidden" name="id" value="<?php echo $record['id_berita']?>">
                    ...
                    <div class="form-group">
                      <label for="">Berita</label>
                        <input type="text" class="form-control" id="" value="<?php echo $record['berita']?>" name="berita" placeholder="Isikan berita" required>
                    </div>
                      <div class="form-group">
                      <label for="">Tanggal</label>
                        <input type="date" class="form-control"  name="tanggal" value="<?php echo $record['tanggal']?>" placeholder="Isikan berita" required>
                    </div>
                    <div class="form-group">
                      <label for="">Keterangan</label>
                        <textarea style="height:100px"  class="ckeditor" name="keterangan" placeholder="Isikan Keterangan berita"><?php echo $record['keterangan']?></textarea>                
                    </div>
